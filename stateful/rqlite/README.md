...
> <strong>Note</strong>: Please follow the [new documentation](https://github.com/rqlite/rqlite/blob/master/DOC/KUBERNETES.md) for deploying latest version of rqlite on Kubernetes, which includes a new YAML for setting up rqlite stateful set.
